...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const url = "https://job-info-backend.herokuapp.com/api/recruiterAuth";
  ...
  return <div className='box'>
    ...
    <Form onSubmit={handleSubmit} >
      ...
      <Form.Text style={{ fontSize: 40, paddingLeft: 35, paddingBottom: 20 }}>Recruiters Login</Form.Text>
      ...
      <Link to="/recruiter-register"><Form.Text className='register-btn'>Register?</Form.Text></Link>
    </Form>
