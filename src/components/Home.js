        ...
        <>
            ...
            <div className='home'>
                <div className='searchForm'>
                    <input type="text" onChange={event => setQuery(event.target.value)} placeholder="Search.." id="search" />
                ...
                <div className='jobCards'>
                    ...
                    {get.filter(post => {
                        ...
                        <div className='jobcard'>
                            ...
                            <div className='apply'>
                                {user ?
                                    <button id="applybtn" onClick={handleShow}>Apply</button> :
                                    <Link to="/login"><button id="applybtn" onClick={handleShow}>Apply</button></Link>
                                }
                            </div>
